...
//  Number
//
//  Created by Thomas on 2022/4/26.
//
...
struct ContentView: View {
    ...
    var body: some View {
        ...
        .alert(isPresented: $isFull, content: {
            return Alert(title :Text("Your Score : \(score) !!"),
                         primaryButton: .default(Text("ok")),
                         secondaryButton: .default(Text("restart"))/*, actions : {
                            initial()
                            }*/
                         )
        })
        .alert(isPresented: $showSecondView, content:{
            return Alert(title : Text("Are You Ready ??")
                         ,dismissButton: .default(Text("Yes"),action:{
                            initial()
